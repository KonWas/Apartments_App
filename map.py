...
#         self.browser.load(QUrl.fromLocalFile(r"G:\_sem4_msid\lab\projekt\wroclaw_map.html"))
...
if __name__ == '__main__':
    create_map()  # Utwórz mapę tylko jeśli jeszcze nie istnieje
    app = QApplication(sys.argv)
    ex = MapWindow()
    ex.show()
    sys.exit(app.exec_())
